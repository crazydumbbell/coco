...
namespace BayatGames.SaveGamePro.PlayMaker.Actions
{
    ...
    public class SaveGameLoadFloatArray : FsmStateAction
    {
        ...
        public override void OnEnter()
        {
            ...
            {
                var array = SaveGame.Load<float[]>(identifier.Value);
                valueArray.Values = Array.ConvertAll<float, object>(array, (item) =>
                {
                    return (object)item;
                });
            }
